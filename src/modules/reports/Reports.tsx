...
export default function Reports() {
  ...
  const { data: financialLogs = [], isLoading } = useQuery({
    ...
    queryFn: () =>
      logsService.getFinancialLogs(getDateRange().start, getDateRange().end),
  });
          ...
          <div className="flex items-center space-x-3">
            ...
            <div>
              ...
              <p className="text-sm text-gray-500">
                Reporte financiero del{' '}
                {format(new Date(start), 'dd/MM/yyyy', { locale: enUS })} al{' '}
                {format(new Date(end), 'dd/MM/yyyy', { locale: enUS })}
              </p>
            </div>
          </div>
        ...
        <div className="h-full overflow-y-auto p-6">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <div className="text-right">
                    ...
                    <p className="text-xs text-gray-500">
                      {salesSummary.cashTransactions} transacciones
                    </p>
                  </div>
                </div>
                <div className="flex items-center justify-between">
                  ...
                  <div className="text-right">
                    ...
                    <p className="text-xs text-gray-500">
                      {salesSummary.cardTransactions} transacciones
                    </p>
                  </div>
                </div>
                <div className="flex items-center justify-between">
                  ...
                  <div className="text-right">
                    <p className="text-sm font-bold text-gray-900">
                      {salesSummary.transferSales.toFixed(2)}€
                    </p>
                    <p className="text-xs text-gray-500">
                      {salesSummary.transferTransactions} transacciones
                    </p>
                  </div>
                </div>
              </div>
          ...
          <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-200 mt-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-sm">
              ...
              <div className="bg-gray-50 p-3 rounded">
                <p className="font-medium text-gray-700">Logs Filtrados</p>
                <p className="text-2xl font-bold text-green-600">
                  {filteredLogs.length}
                </p>
              </div>
              <div className="bg-gray-50 p-3 rounded">
                <p className="font-medium text-gray-700">Logs Excluidos</p>
