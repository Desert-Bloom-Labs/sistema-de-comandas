          ...
          <div className="grid grid-cols-1 xl:grid-cols-4 gap-6 p-6 h-full">
            ...
            <div className="space-y-4">
              ...
              <div className="bg-purple-50 p-4 rounded-xl border border-purple-200">
                <h4 className="text-base font-semibold text-purple-800 mb-3">
                  Distribución
                </h4>
            ...
            <div className="space-y-4">
              {splitMode === 'custom' && (
                <div className="bg-yellow-50 p-4 rounded-xl border border-yellow-200">
                  <h4 className="text-base font-semibold text-yellow-800 mb-3">
                  ...
                  <div className="space-y-2 max-h-48 overflow-y-auto">
                    {cartItems.map(item => {
                      const assignedTicket =
                        itemAssignments[item.product_id]?.[0]; // One ticket per item
                      return (
                        <div
                          key={item.product_id}
                        ...
                        >
                          ...
                          {assignedTicket && (
                            <div className="text-xs text-green-600 mt-1">
                              → Persona {assignedTicket.replace('ticket-', '')}
                            </div>
                          )}
                        </div>
                      );
              ...
              <div className="bg-blue-50 p-4 rounded-xl border border-blue-200">
                ...
                <div className="space-y-2 text-sm">
                  ...
                  <div className="flex justify-between">
                    ...
                    <span className="font-medium">
                      {formatAmount(getCartTotalWithTax() / splitCount)}
                    </span>
                  </div>
                </div>
              </div>
