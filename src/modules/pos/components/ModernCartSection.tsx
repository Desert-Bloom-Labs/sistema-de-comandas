        ...
        {cartItems.length === 0 ? (
          <div className="flex flex-col items-center justify-center text-slate-400 h-full">
            ...
            <p className="text-xs text-slate-500 text-center">
              {selectedTable
                ? `Selecciona productos para la mesa ${selectedTable.number}`
      ...
      <div className="border-t border-slate-700 bg-slate-800 p-2 space-y-2 flex-shrink-0">
          ...
          <div className="grid grid-cols-3 gap-1">
            {paymentMethods.map(method => (
              <button
                ...
                className={`flex flex-col items-center p-1.5 rounded-lg border transition-all duration-200 ${
        ...
        <div className="space-y-1">
          ...
          >
            ...
            <span>Pagar {formatAmount(getCartTotalWithTax())}</span>
          </button>
          ...
          <div className="grid grid-cols-2 gap-1">
            <button
              ...
              disabled={
                !selectedTable || cartItems.length === 0 || isSendingToKitchen
              }
          ...
          >
            ...
            <span className="text-xs">Limpiar carrito</span>
          </button>
        </div>
      </div>
    </div>
