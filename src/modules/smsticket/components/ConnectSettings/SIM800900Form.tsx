        ...
        <div>
          <div className="flex items-center justify-between mb-2">
            ...
            >
              <RefreshCw
                size={14}
                className={isScanningPorts ? 'animate-spin' : ''}
              />
          ...
          {detectedPorts.length > 0 ? (
              ...
              {detectedPorts.map(detectedPort => (
                <div
                  ...
                  className={`p-3 border rounded-lg cursor-pointer transition-all ${
                    formData.port === detectedPort.port
            ...
            <div className="p-4 border border-gray-200 rounded-lg text-center text-gray-500">
              ...
              <p>
                No ports detected. Click "Scan Ports" to search for SIM modules.
              </p>
            </div>
          )}
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div>
            ...
            <select
              ...
              onChange={e =>
                handleInputChange('baud_rate', parseInt(e.target.value))
              }
        ...
        <div className="flex items-start gap-3">
          ...
          <div>
            ...
            <p className="text-sm text-yellow-800 mt-1">
              This provider is currently in development. The interface is ready
              but the actual SMS sending functionality will be implemented
              later.
            </p>
          </div>
        </div>
