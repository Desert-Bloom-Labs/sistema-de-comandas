...
export default function InfobipForm({
    ...
    try {
      ...
      if (result) {
        ...
        setTestResult({
          success: false,
          message:
            "Échec de l'envoi du SMS. Vérifiez la configuration et les crédits Infobip.",
        });
      }
    } catch (error) {
  ...
  const isFormValid =
    formData.api_key && formData.base_url && formData.sender_name;
    ...
    <div className="space-y-6">
          ...
          <div>
            ...
            <ol className="text-sm text-blue-800 mt-2 space-y-1">
              <li>
                ...
                >
                  infobip.com <ExternalLink size={12} />
                </a>
              </li>
      ...
      <div className="space-y-6">
        ...
        <div>
          ...
          />
          <p className="text-xs text-gray-500 mt-1">
            Infobip API base URL (ex: https://1gjwy1.api.infobip.com ou
            ...
            <div className="flex-1">
              ...
              {testResult.details && (
                <div className="mt-3 text-xs text-gray-600">
                  ...
                  <p>
                    <strong>Expéditeur:</strong> {testResult.details.sender}
                  </p>
                  <p>
                    <strong>API:</strong> {testResult.details.base_url}
                  </p>
                </div>
              )}
            </div>
