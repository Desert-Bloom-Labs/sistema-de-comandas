...
export default function Planner() {
  ...
  const handleDeleteLayout = async (layoutId: string) => {
    if (confirm('¿Estás seguro de que deseas eliminar este layout?')) {
    ...
    <div className="flex h-full bg-gray-50">
      ...
      <div className="w-80 bg-white border-r border-gray-200 flex flex-col">
        ...
        <div className="p-4 border-b border-gray-200">
          <h1 className="text-xl font-semibold text-gray-900">Planificador</h1>
          <p className="text-sm text-gray-500 mt-1">
            {currentLayout ? currentLayout.name : 'Ningún layout seleccionado'}
          </p>
        </div>
        ...
        <div className="bg-white border-b border-gray-200 p-4">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-2 text-sm text-gray-600">
              <span>Items en el layout: {currentLayout.items.length}</span>
