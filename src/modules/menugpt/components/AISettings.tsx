...
export default function AISettings() {
  ...
  // Mutación para probar la configuración
  const testConfigMutation = useMutation({
    ...
    onError: error => {
      setTestResult({
        success: false,
        message: `Prueba fallida: ${(error as Error).message}`,
      });
    },
  });
      ...
      <div className="flex items-center space-x-3 mb-4 sm:mb-6">
        ...
        <div>
          ...
          <p className="text-sm sm:text-base text-gray-600">
            Configura Google Gemini para análisis de menús
          </p>
        </div>
      </div>
            ...
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600">
                  Modelo avanzado de IA para análisis de texto e imágenes
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="mt-2 p-3 bg-gray-50 rounded-lg border">
              ...
              <div className="flex items-center gap-2">
                ...
                <button
                  type="button"
                  onClick={() =>
                    handleCopyUrl('https://aistudio.google.com/apikey')
                  }
          ...
          <div className="text-sm text-gray-600 space-y-2">
            ...
            <div className="flex items-center justify-between">
              ...
              <span className="text-gray-900">
                {currentConfig.model || 'gemini-2.0-flash'}
              </span>
            </div>
            <div className="flex items-center justify-between">
              ...
              >
                {currentConfig.is_active ? 'Activo' : 'Inactivo'}
              </span>
            </div>
            <div className="flex items-center justify-between">
