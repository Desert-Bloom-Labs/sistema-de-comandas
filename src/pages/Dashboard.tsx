    ...
    <div className="min-h-screen bg-[#1B2537] relative overflow-hidden">
      ...
      <div className="relative z-10 p-8">
        ...
        <div className="mb-8 text-center">
          <h1 className="text-5xl font-bold text-white">Zikiro</h1>
        </div>
        ...
        {totalPages > 1 && (
          <>
            ...
            <button
              ...
              className={`fixed left-4 top-1/2 transform -translate-y-1/2 z-20 p-3 rounded-full transition-all duration-300 ${
                currentPage === 0
            ...
            <button
              ...
              className={`fixed right-4 top-1/2 transform -translate-y-1/2 z-20 p-3 rounded-full transition-all duration-300 ${
            ...
            <div className="col-span-2">
              {shouldShowPOS && mainModules.find(m => m.id === 'pos') && (
                <div className="inline-block m-8 cursor-pointer relative">
                  ...
                  <div className="absolute -top-12 left-1/2 transform -translate-x-1/2 text-white font-semibold text-lg no-wrap-text">
                    Punto de Venta
                  </div>
        ...
        <div className="mt-16 text-center text-gray-400">
          <p className="text-lg">
            Bienvenido a Zikiro v0.1.0 - El Sistema Inteligente de Punto de
            Venta
          </p>
          <p className="text-sm mt-2">Selecciona un módulo para comenzar</p>
        </div>
      </div>
